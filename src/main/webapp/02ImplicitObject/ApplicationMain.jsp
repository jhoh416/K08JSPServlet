...
<body>
	...
	파일을 실행한다. 따라서 아래의 물리적 경로는 .metadata하위의
	경로가 출력된다.
	 -->
	...
	내장객체는 _jspService() 메서드내에서 생성된 지역변수 이므로
	...
	*/
	public String useImplicitObject(){
		...
		*/
		return this.getServletContext().getRealPath("/20ImplicitObject");
	}
	public String useImplicitObject(ServletContext app){
		/* 
		방법2 : 스트립트렛에서 메서드를 호출할때 application 내장객체를
			매개변수로 전달해서 사용한다.
		*/
