...
try{
	...
	*/
	...
	//파일명에서 확장자 앞의 .(닷)을 찾아 인덱스를 확인후 확장자를
	//잘라낸다. 확장자는 파이르이 용도를 나타내는 부분이므로 중요하다.
	...
	여기서 사용된 seperator는 경로를 표시할때 사용하는 구분기호로
	윈도우의 경우 \(역슬러쉬), 리눅스의 경우\ (슬러쉬)룰 자동으로
	...
	*/
	...
	/* 
	파일을 제외한 나머지 폼값을 받는다. 단 이때 request 내장객체를 통해서가
	아니라 mr객체를 통해 받아야 하므로 주의해야 한다. 객체는 다르지만 폼값을
	받기위한 메서드명은 동일하다.
	*/
