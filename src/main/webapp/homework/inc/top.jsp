...
<div class="col-12">
            ...
            <nav class="navbar navbar-expand-sm bg-warning navbar-secondary">
                ...
                %>
					...
					<li class="nav-item">
                        <a class="nav-link" href="../hwLogin/hwLogin.jsp"><i class='bi bi-box-arrow-in-right'
					...
					<li class="nav-item">
						...
						<a class="nav-link" href="#"><span style="font-weight:bold"><%= session.getAttribute("UserName").toString() %>님</span><i class='bi bi-person-lines-fill' style='font-size:20px'></i>회원정보수정</a>
					</li>
                    
                    <li class="nav-item">
                        <a class="nav-link" href="../hwLogin/hwLogout.jsp"><i class='bi bi-box-arrow-right'
