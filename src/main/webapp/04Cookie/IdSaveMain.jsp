...
<body>
	...
	태그순으로 포커스가 이동하게 된다. 이를 변경할때 tabindex속성을
	사용한다. -->
	<form action="IdSaveProcess.jsp" method="post">
	<!-- 
	쿠키를 통해 읽어온 값이 있는경우 text 상자에는 value속성을
	통해 저장된 아이디를 추가하고 , checkbox에는 checked 속성을
	부여한다.
	 -->
	아이디 : <input type="text" name="user_id" value="<%= loginId %>" tabindex="1"/>
		...
		아이디 저장하기
	<br />
	패스워드 : <input type="text" name="user_pw" tabindex="3"/>
	<br />
