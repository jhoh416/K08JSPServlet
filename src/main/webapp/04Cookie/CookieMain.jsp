...
<!-- 
	...
	PC에 파일형태로 저장된다. 쿠키하나의 크기는 4kb이고 , 3000개
	까지 만들 수 잇다.
 -->
	<h2>1. 쿠키(Cookie) 설정</h2>
	<%
	/* 
	쿠키는 생성자를 통해서만 생성할 수 있다. setName()이란 페서드가
	...
	*/
	...
	<%
	/* 
	request내장객체의 getCookies()을 통해 현재 생성된 모든 쿠키를
	배열의 형태로 가져온다.
	*/
	...
	/* 
	쿠키가 생성된 직후에는 쿠키값을 읽을수 없다. 클라이언트 측에 있는
	쿠키를 서버로 다시 전송하기 위해 페이지 이동을 하거나
	새로고침을 하여 새로운 요청을 보내야만 읽을 수 있다.*/
	%>
