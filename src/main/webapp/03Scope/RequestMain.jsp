...
즉 request영역에 저장된 정보는 현재 페이지와 포워드(Forward)된
페이지까지 공유된다.
*/
...
<body>
	...
	<%
		//request 영역에 저장되어 있으므로 정상적으로 삭제된다.
	...
	<%
	/* 
	포워드 : 현재 페이지로 들어온 요청을 다음 페이지로 보내는 기능을
		말한다. 즉 하나의 요청을 둘 이상의 페이지가 공유할 수 있다.
		포워드 명령을 만나기 전까지 의 모든 내용은 버퍼에서 삭제되고,
		포워드 된 페이지의 내용만 화면에 출력하는 특징을 가진다.
		즉 포워드란 현재 페이지로 들어온 요청을 다른 페이지에서도
		공유할 수 있도록 전달하는것을 말한다.
	*/
